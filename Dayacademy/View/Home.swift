...
//  Dayacademy
//
//  Created by Rido Hendrawan on 28/07/22.
//
...
struct Home: View {
    ...
    // MARK: Tasks View (update dynamically when ever user is tapped on another date)
